...
const Points = () =>{
    ...
    useEffect(()=>{
        async function loadPosition(){
            ...
            if(status!=='granted'){
                Alert.alert('ooops','Presisamos de sua permisão para obter a localização')
                return
            }
...
useEffect(()=> {
    ...
    function handleSelectItem(id:number){
        const altereadySelected = selectedItems.findIndex(item=> item ===id)
        if(altereadySelected >=0){
